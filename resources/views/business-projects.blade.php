...
<title>Business Projects - NAYLA</title>
<!-- Tailwind CSS -->
...
<div class="relative group">
    <button class="text-primary font-bold flex items-center gap-1 focus:outline-none">
        Business <span class="material-symbols-outlined text-[16px]">expand_more</span>
    </button>
    <div class="absolute left-0 top-full mt-2 w-40 bg-surface-container-high border border-outline-variant/30 rounded-lg shadow-xl opacity-0 invisible group-focus-within:opacity-100 group-focus-within:visible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 flex flex-col py-2 backdrop-blur-xl">
        <a href="/data" class="px-4 py-2 hover:bg-primary/10 hover:text-primary transition-colors text-left text-on-surface">Data</a>
        ...
        <a href="/business" class="px-4 py-2 hover:bg-primary/10 hover:text-primary transition-colors text-left text-primary font-bold">Business</a>
...
<header class="mb-16 relative z-10">
    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-300 font-label-mono text-xs w-max mb-6 backdrop-blur-md">
        <span class="material-symbols-outlined text-[14px]">storefront</span> Discipline
    </div>
    <h1 class="font-display text-5xl md:text-7xl font-bold tracking-tighter text-on-surface mb-6">
        <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-fuchsia-400 to-primary">Business</span> Projects.
    </h1>
    <p class="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
        Strategic case studies, process optimizations, and market analysis presentations.
    </p>
</header>
...
<button class="px-5 py-2 border border-outline-variant text-on-surface-variant hover:border-primary/50 hover:text-on-surface rounded-full transition-colors">Strategy</button>
<button class="px-5 py-2 border border-outline-variant text-on-surface-variant hover:border-primary/50 hover:text-on-surface rounded-full transition-colors">Analytics</button>
<button class="px-5 py-2 border border-outline-variant text-on-surface-variant hover:border-primary/50 hover:text-on-surface rounded-full transition-colors">Marketing</button>
<button class="px-5 py-2 border border-outline-variant text-on-surface-variant hover:border-primary/50 hover:text-on-surface rounded-full transition-colors">Operations</button>
</div>
<!-- Search -->
